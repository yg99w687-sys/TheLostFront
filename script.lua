...
local function Show_Protection_Notification()
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            ...
            Duration = 7; -- مدة ظهور حقيقية 7 ثوانٍ كاملة بالإنجليزية
            Icon = "rbxassetid://6034289516";
        })
    end)
end

--// Admin Webhook Logging (Secure Background Request)
...
enterBtn.MouseButton1Click:Connect(function()
    if box.Text == CORRECT_KEY then
        ...
        -- تفعيل نظام الإشعار الاحترافي لمدة 7 ثوانٍ
